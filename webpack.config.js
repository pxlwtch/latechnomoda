...
module.exports = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({filename: 'beverly.html', template: 'src/case-study/beverly.html'}),
    new HtmlWebpackPlugin({filename: 'bandshite.html', template: 'src/case-study/bandshite.html'}),
    extractSass,
    extractSass
  ],
  module: {
